...
# Replace this with the actual file if different
data = pd.read_csv("Data/Salary Data.csv")  # Example: 'preprocessed_salary_data.csv'
...
# Step 4: Load the trained model pipeline
model = joblib.load("model/salary_predictor_corrected.pkl")

# Step 5: Predict salaries using the model
y_pred = model.predict(X_test)

# Step 6: Create an evaluation table
...
# Step 7: Save the evaluation table to a CSV file
eval_df.to_csv("model_evaluation_table.csv", index=False)
print("✅ model_evaluation_table.csv has been saved successfully.")

#train 
joblib.dump(model, "salary_predictor_corrected.pkl")
